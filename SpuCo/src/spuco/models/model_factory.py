...
from spuco.models import MLP, Bert, DistilBert, LeNet, SpuCoModel, CaSNModel
...
def casn_model_factory(arch: str, input_shape: Tuple[int, int, int], num_classes: int, pretrained: bool = True):
    """
    Factory function to create a SpuCoModel based on the specified architecture.
