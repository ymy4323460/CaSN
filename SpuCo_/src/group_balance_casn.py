...
from spuco.robust_train import GroupBalanceCaSN
...
parser.add_argument("--lambda_", type=float, default=20)

parser.add_argument("--root_dir", type=str, default="./data")
parser.add_argument("--label_noise", type=float, default=0.0)
parser.add_argument("--results_csv", type=str, default="./results/spucoanimals_group_balance_casn")
...
model = casn_model_factory(args.arch, trainset[0][0].shape, trainset.num_classes, pretrained=args.pretrained).to(device)
...
group_balance = GroupBalanceCaSN(
    model=model,
...
print('Done!')
print('Results saved to', args.results_csv+str(args.seed)+str(args.bias)+str(args.lambda_)+'.csv')
results_csv_path = args.results_csv+str(args.seed)+str(args.bias)+str(args.lambda_)+'.csv'
