...
if os.path.exists(args.results_csv+str(args.seed)+'.csv'):
    results_df = pd.read_csv(args.results_csv+str(args.seed)+'.csv')
else:
    results_df = pd.DataFrame()

results_df = pd.concat([results_df, results], ignore_index=True)
results_df.to_csv(args.results_csv+str(args.seed)+'.csv', index=False)

print('Done!')
print('Results saved to', args.results_csv+str(args.seed)+'.csv')
